...
([`owncloud/php`](https://hub.docker.com/r/owncloud/php)). It is not an
application codebase — it layers PHP (7.4 on Ubuntu 22.04, 8.3 on Ubuntu 24.04)
and an Apache webserver on top of the
[`owncloud/ubuntu`](https://github.com/owncloud-docker/ubuntu) image. See the
